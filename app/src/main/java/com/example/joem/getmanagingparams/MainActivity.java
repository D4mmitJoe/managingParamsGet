package com.example.joem.getmanagingparams;
...
public class MainActivity extends AppCompatActivity {
        ...
        findViewById(R.id.buttonCheckConnection).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isConnected()){
                    ...
                    new GetDataParamsUsingGetAsync(paramsName).execute("http://api.theappsdr.com/params.php");
                }else{
    ...
    private class GetDataParamsUsingGetAsync extends AsyncTask<String, Void, String> {
        ...
        //constructor
        public GetDataParamsUsingGetAsync(RequestParams paramsName){
